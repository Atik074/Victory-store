  ...
  return (
    <>
      {products.slice(0, 10).map((product) => (
        ...
        >
          <div className="imgWrapper w-[450px] h-[300px]   overflow-hidden relative">
            <Link to="/">
            ...
            <div>
              <button
                className="heartSvg w-[40px] h-[40px]  rounded-[100%]    absolute top-[30px] left-[235px]  text-black 
                    bg-[#f1f2f6]
          ...
          <div className="px-3 my-10">
            ...
            <Rating
              ...
              readOnly
            />
            <p className="text-[18px] mt-1 mr-8">
